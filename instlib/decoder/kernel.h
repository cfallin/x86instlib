...
public:
  ...
  bool dtlbcheck(void* page) const { return false; }
  void dtlbset(void* page) { }
  void dtlbclear(void* page) { }

  bool itlbcheck(void* page) const { return false; }
  void itlbset(void* page) { }
  void itlbclear(void* page) {  }

  bool istrans(Waddr mfn) {  return false; }
  void settrans(Waddr mfn) {  }
  void cleartrans(Waddr mfn) {  }

  bool isdirty(Waddr mfn) { return false; }
  void setdirty(Waddr mfn) {  }
  void cleardirty(Waddr mfn) {  }

  void resync_with_process_maps();
};

static inline bool smc_istrans(Waddr mfn) { return false; }
static inline void smc_settrans(Waddr mfn) {  }
static inline void smc_cleartrans(Waddr mfn) { }

static inline bool smc_isdirty(Waddr mfn) { return false; }
...
inline int Context::copy_from_user(void* target, Waddr addr, int bytes, PageFaultErrorCode& pfec, Waddr& faultaddr, bool forexec, Level1PTE& ptelo, Level1PTE& ptehi) {
  ...
  readable = true;
  if likely (forexec) executable = true;
