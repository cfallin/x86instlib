...
static const union { uint4 u[880]; int4 i[880]; double x[440]; } sincos = { {
...
#define  EZ  z->e
  ...
  typedef union { unsigned int u[2]; int i[2]; double d; } number;
#define MIN min
#define MAX max
...
#undef S
  ...
  double __ieee754_exp2(double x) {
    ...
    if (__isless (x, himark) && __isgreaterequal (x, lomark)) {
